...
public class TranslateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outputTextView = (TextView) findViewById(R.id.txt_Result);
         ...
         dropdownInput = (Spinner) findViewById(R.id.spinner1);

        // Create an ArrayAdapter using the string array and a default spinner
        ArrayAdapter<CharSequence> staticAdapter = ArrayAdapter
                .createFromResource(this, R.array.input_language_arrays,
        ...
        dropdownInput.setAdapter(staticAdapter);

        dropdownOutput = (Spinner) findViewById(R.id.spinner2);

        // Create an ArrayAdapter using the string array and a default spinner
        ArrayAdapter<CharSequence> staticAdap = ArrayAdapter
                .createFromResource(this, R.array.output_language_arrays,
                        android.R.layout.simple_spinner_item);
        ...
        // Apply the adapter to the spinner
        dropdownOutput.setAdapter(staticAdap);
    ...
    public void translateText(View v) {
        ...
        String inputLanguage = dropdownInput.getSelectedItem().toString();
        String outputLanguage = dropdownOutput.getSelectedItem().toString();
        String inputLanguageCode="";
        String outputLanguageCode="";

        switch(inputLanguage) {
            case "Telugu":
                inputLanguageCode = "te";
                break;
            case "Chinese":
        ...
        switch(outputLanguage) {
            case "Telugu":
                outputLanguageCode = "te";
                break;
            case "Chinese":
                outputLanguageCode = "zh";
                break;
            case "Hindi":
                outputLanguageCode = "hi";
                break;
            case "Russian":
                outputLanguageCode = "ru";
                break;
            case "Spanish":
        ...
        String getURL = "https://translate.yandex.net/api/v1.5/tr.json/translate?" +
                ...
                "lang="+inputLanguageCode+"-"+outputLanguageCode+"&[format=plain]&[options=1]&[callback=set]";//The API service URL
